               ...
               <section  class="sky-form">
                  <h4>Category</h4>
                        <div class="row row1 scroll-pane">
                                <div class="col col-4">
                                        <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Nước ép Detox</label>
                                </div>
                                <div class="col col-4">
                                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Nước ép có gas</label>
                                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Nước ép không có gas</label>
                                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Nước ép Pom</label>
                                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Khác</label>
                            </div>
                         </div>
<!--                  <h4>Category</h4>
                        <div class="row row1 scroll-pane">
     ...
     <div class="toogle">
        ...
        <div class="fb-comments" data-href="http://localhost:8080/WebApplication2/Single.jsp?Product=<%=Product.getMasp()%>" data-width="100%" data-numposts="5"></div>
         ...
         <ul id="flexiselDemo3">
            <li><img src="images/pic11.jpg" /><div class="grid-flex"><a href="#">TÁO BUNDABERG</a><p></p></div></li>
            <li><img src="images/pic10.jpg" /><div class="grid-flex"><a href="#">SƠ RI CHANH DÂY DỨA LE</a><p></p></div></li>
            <li><img src="images/pic9.jpg" /><div class="grid-flex"><a href="#">ỔI LE FRUIT</a><p></p></div></li>
            <li><img src="images/pic8.jpg" /><div class="grid-flex"><a href="#">ỔI LE FRUIT NECTAR</a><p></p></div></li>
            <li><img src="images/pic7.jpg" /><div class="grid-flex"><a href="#">ỔI BUNDABERG</a><p></p></div></li>
         </ul>
	    <script type="text/javascript">
